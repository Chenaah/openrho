...
class PIn1Pytorch(nn.Module):
    ...
    #     embs = torch.cat(embs, dim=1) # (batch_size, num_img_tokens, hidden_dim) * len(images) + (batch_size, num_lang_tokens, hidden_dim)
    ...
    def forward(self, observation, actions, noise=None, time=None) -> Tensor:
        ...
        # import pdb; pdb.set_trace() # [2, 32, 32]
        ...
        suffix_out = self._apply_checkpoint(
            forward_func, None, suffix_embs, att_2d_masks_4d, position_ids, adarms_cond
        )
    ...
    def sample_actions(self, device, observation, noise=None, num_steps=10) -> Tensor:
        ...
        # _, prefix_past_key_values = self.paligemma_with_expert.forward(
